...
describe('When API returns valid results', () => {
  const apiResponse1 = new ApiResponse(42.302, -71.176, 0, '2018-03-19 06:00')
  const apiResponse2 = new ApiResponse(42.302, -71.176, 1.05, '2018-03-19 22:00')
  const windData1 = new WindData(apiResponse1.windSpeed, moment.tz(apiResponse1.observationTime, timezone))
  const windData2 = new WindData(apiResponse2.windSpeed, moment.tz(apiResponse2.observationTime, timezone))
